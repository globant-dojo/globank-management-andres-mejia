...
namespace DojoProject.Infrastructure.Adapters {
    
    public class GenericRepository<E> : IGenericRepository<E> where E : DojoProject.Domain.Entities.Base.DomainEntity
    {
